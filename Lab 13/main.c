...
int main(void)
{
    ...
    printf("\n/*********************** Testing print_dictionary **********************\\\n\n");
    print_dictionary(addresses);

    printf("\n/*********************** Testing replace **********************\\\n\n");
    replace(addresses, "Babak", "lynn.marshall@carleton.ca");
    replace(addresses, "Don", "lynn.marshall@carleton.ca");
    replace(addresses, "Donald", "lynn.marshall@carleton.ca");
    replace(addresses, "Lynn", "bob@bob.com");
